// kernel/core/ipc — fixed-layout message data used by retained ABI fixtures.
// The former kernel IPC policy layer was removed from the core validation scope;
// this file remains only as a small structured-value example.
