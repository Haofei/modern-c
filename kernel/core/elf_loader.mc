...
//
// This is the substrate for loading an untrusted validation image into an isolated Sv39
// space: the loader never trusts a program-header field. Each segment's
