...
pub fn tcp_write(w: *ByteWriter, off: usize, src_ip: u32, dst_ip: u32, src_port: u16, dst_port: u16, seq: u32, ack: u32, flags: u16, window: u16, payload_len: usize) -> void {
...
pub fn tcp_parse(r: *ByteReader, off: usize) -> TcpHeader {
...
pub fn tcp_checksum_valid(r: *ByteReader, off: usize, src_ip: u32, dst_ip: u32, seg_len: u16) -> bool {
    var sum: u32 = inet_pseudo_sum(src_ip, dst_ip, IP_PROTO_TCP, seg_len);
...
pub fn tcp_flag_set(flags: u16, flag: u16) -> bool {
    return (flags & flag) != 0;
}
