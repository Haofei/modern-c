...
// BSS-corruption / device-handshake-hang class is structurally impossible). The generated header
// also carries the A1 sizeof/offsetof asserts. No hand-written mirror remains here.
