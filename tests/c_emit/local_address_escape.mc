...
fn return_parameter_pointer_alias(p: *mut u32) -> *mut u32 {
    let q: *mut u32 = p;
    return q;
}

fn return_const_parameter_pointer_alias(p: *const u32) -> *const u32 {
    let q: *const u32 = p;
    return q;
}
...
fn copied_after_cleared_local_pointer_alias(p: *mut u32) -> *mut u32 {
    var x: u32 = 1;
    var out: *mut u32 = p;
    out = &x;
    out = p;
