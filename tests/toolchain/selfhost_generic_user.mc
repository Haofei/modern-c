...
// `fn unbox(comptime T: type, b: Box<T>) -> T`, generic type usages `Box<u32>`/`Box<u64>`, and
// generic calls `unbox(u32, ..)`/`unbox(u64, ..)` — end to end through lex -> parse -> sema -> emit.
//
...
fn accept_bytes() -> [314]u8 {
    return .{
        ...
        125, 32, 101, 120, 112, 111, 114, 116, 32, 102, 110, 32, 114, 117, 110, 40, 97, 58, 32,
        117, 51, 50, 44, 32, 99, 58, 32, 117, 51, 50, 41, 32, 45, 62, 32, 117, 51, 50, 32, 123, 32,
        118, 97, 114, 32, 98, 105, 58, 32, 66, 111, 120, 60, 117, 51, 50, 62, 32, 61, 32, 46, 123,
        32, 46, 118, 32, 61, 32, 97, 32, 125, 59, 32, 118, 97, 114, 32, 98, 106, 58, 32, 66, 111,
        120, 60, 117, 51, 50, 62, 32, 61, 32, 46, 123, 32, 46, 118, 32, 61, 32, 99, 32, 125, 59,
        32, 114, 101, 116, 117, 114, 110, 32, 117, 110, 98, 111, 120, 40, 117, 51, 50, 44, 32, 98,
        105, 41, 32, 43, 32, 117, 110, 98, 111, 120, 40, 117, 51, 50, 44, 32, 98, 106, 41, 59, 32,
        125, 32, 101, 120, 112, 111, 114, 116, 32, 102, 110, 32, 114, 117, 110, 54, 52, 40, 97, 58,
        32, 117, 54, 52, 41, 32, 45, 62, 32, 117, 54, 52, 32, 123, 32, 118, 97, 114, 32, 98, 58,
        32, 66, 111, 120, 60, 117, 54, 52, 62, 32, 61, 32, 46, 123, 32, 46, 118, 32, 61, 32, 97,
        32, 125, 59, 32, 114, 101, 116, 117, 114, 110, 32, 117, 110, 98, 111, 120, 40, 117, 54, 52,
        44, 32, 98, 41, 59, 32, 125,
    };
}
