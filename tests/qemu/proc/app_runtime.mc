...
// the confined C app hosts) carries a 14 MiB malloc arena in .bss — the loader maps the whole PT_LOAD memsz, so the
...
global g_region: [67112960]u8; // 64 MiB + 4 KiB (page-align headroom)
