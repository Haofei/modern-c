...
extern fn mc_dns_server_port() -> u16;
...
export fn test_main() -> void {
    ...
    let dns_port: u16 = mc_dns_server_port();
    ...
    let st: u32 = dns_http_drive(regs, &g_rxq, &g_txq, dns_ip, dns_port, http_port, rxbuf, 2048);
    uputs("DRIVE-STATUS=");
    uputhex(st as u64);
    uputc(10);
