...
const LlvmEmitter = struct {
    ...
    fn simpleMirOptionalDirectVoidCallSourceInBlock(self: *LlvmEmitter, function: anytype, fn_mir: mir.Function, block: mir.Block) ?SimpleMirOptionalDirectCallSource {
