...
const LlvmEmitter = struct {
    ...
    fn simpleMirParamFieldReturn(self: *LlvmEmitter, function: anytype, fn_mir: mir.Function, block: mir.Block, ret: mir.Instruction, field_name: []const u8) ?SimpleMirParamField {
        _ = fn_mir;
