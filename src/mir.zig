...
pub const ExecutableRepresentationObligation = mir_model.ExecutableRepresentationObligation;
...
pub const RepresentationUseKind = mir_model.RepresentationUseKind;
pub const ExecutableNode = mir_model.ExecutableNode;
pub const instructionJoinsExecutableBody = mir_model.instructionJoinsExecutableBody;
pub const executableNodeForInstruction = mir_model.executableNodeForInstruction;
pub const executableStatementForInstruction = mir_model.executableStatementForInstruction;
pub const executableExpressionForInstruction = mir_model.executableExpressionForInstruction;
pub const representationUseForInstruction = mir_model.representationUseForInstruction;
pub const targetTypeKindForInstruction = mir_model.targetTypeKindForInstruction;
...
pub const Finding = mir_model.Finding;
pub const FindingKind = mir_model.FindingKind;
pub const MmioFinding = mir_model.MmioFinding;
