...
pub fn appendLayoutAsserts(allocator: std.mem.Allocator, module: ast.Module, out: *std.ArrayList(u8), struct_names: []const []const u8) anyerror!void {
    ...
    try emitter.collectModule(legacy_backend_syntax.LegacyDeclarationSlice.forDecls(module.decls).earlyDeclarationMetadata());
...
pub fn appendModule(
    ...
    try appendModuleMir(allocator, legacy_backend_syntax.LegacyDeclarationSlice.forDecls(module.decls).earlyDeclarationMetadata(), &typed_mir, out, source_path, ksan, msan, csan, stub_asm, reporter);
}
...
pub const CEmitter = struct {
    ...
    fn collectModule(self: *CEmitter, early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView) anyerror!void {
    ...
    fn emitModule(self: *CEmitter, early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView) anyerror!void {
