...
pub fn appendLayoutAsserts(allocator: std.mem.Allocator, module: ast.Module, out: *std.ArrayList(u8), struct_names: []const []const u8) anyerror!void {
    ...
    try emitter.collectModule(backend_mod.LegacyDeclarationSlice.forDecls(module.decls));
...
pub fn appendModule(
    ...
    try appendModuleMir(allocator, backend_mod.LegacyDeclarationSlice.forDecls(module.decls), &typed_mir, out, source_path, ksan, msan, csan, stub_asm, reporter);
}
...
pub const CEmitter = struct {
    ...
    fn collectModule(self: *CEmitter, declarations: backend_mod.LegacyDeclarationSlice) anyerror!void {
    ...
    fn emitModule(self: *CEmitter, declarations: backend_mod.LegacyDeclarationSlice) anyerror!void {
