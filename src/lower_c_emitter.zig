...
pub fn appendLayoutAsserts(allocator: std.mem.Allocator, module: ast.Module, out: *std.ArrayList(u8), struct_names: []const []const u8) anyerror!void {
    ...
    try emitter.collectModule(legacy_backend_syntax.EarlyDeclarationMetadataView.forDecls(module.decls));
...
pub fn appendModule(
    ...
    try appendModuleMir(allocator, legacy_backend_syntax.EarlyDeclarationMetadataView.forDecls(module.decls), &typed_mir, out, source_path, ksan, msan, csan, stub_asm, reporter);
}
