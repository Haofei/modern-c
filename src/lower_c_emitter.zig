...
pub fn appendLayoutAsserts(allocator: std.mem.Allocator, module: ast.Module, out: *std.ArrayList(u8), struct_names: []const []const u8) anyerror!void {
    ...
    try emitter.collectModule(early_declaration_metadata.EarlyDeclarationMetadataView.forDecls(module.decls));
...
pub fn appendModule(
    ...
    try appendModuleMir(allocator, early_declaration_metadata.EarlyDeclarationMetadataView.forDecls(module.decls), &typed_mir, out, source_path, ksan, msan, csan, stub_asm, reporter);
}
...
pub const CEmitter = struct {
    ...
    fn collectModule(self: *CEmitter, early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView) anyerror!void {
    ...
    fn emitModule(self: *CEmitter, early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView) anyerror!void {
