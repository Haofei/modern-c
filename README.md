...
llvm-udp-net-test` for typed MMIO, timer traps, cooperative context switching,
...
server handshake, virtio-net device bring-up, and pcap-verified UDP transmit. `zig build llvm-kmain-test` boots the integrated
