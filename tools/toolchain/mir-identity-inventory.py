...
def main() -> int:
    ...
    for path, needle in (
        ...
        ("src/mir_model.zig", "pub const DeferCleanupEdgeKind"),
        ("src/mir_model.zig", "pub const DeferCleanupEdgeActionRef"),
        ("src/mir_model.zig", "pub const DeferCleanupEdge = struct"),
        ("src/mir_model.zig", "pub const DeferCleanupEdgeTable"),
        ("src/mir_model.zig", "pub const CleanupCfgEdgeKind"),
        ("src/mir_model.zig", "pub const CleanupCfgActionRef"),
        ("src/mir_model.zig", "pub const CleanupCfgEdge = struct"),
        ("src/mir_model.zig", "pub const CleanupCfg"),
        ...
        ("src/mir.zig", "pub fn buildDeferCleanupEdgeTable"),
        ("src/mir.zig", "pub fn deferCleanupEdgeTableValid"),
        ("src/mir.zig", "pub fn deferCleanupEdgeTableContainsRef"),
        ("src/mir.zig", "pub fn buildCleanupCfg"),
        ("src/mir.zig", "pub fn buildCleanupCfgFromEdgeTables"),
        ("src/mir.zig", "pub fn cleanupCfgValid"),
        ...
        ("src/backend_cleanup.zig", "pub const CleanupCursor"),
        ("src/backend_cleanup.zig", "pub const CleanupState"),
        ("src/backend_cleanup.zig", "pub fn rootCleanupCursor"),
        ("src/backend_cleanup.zig", "pub fn cleanupCursorIndex"),
        ("src/backend_cleanup.zig", "pub fn restoreToCursor"),
        ("src/backend_cleanup.zig", "fn deferCleanupRefsValid"),
        ("src/backend_cleanup.zig", "pub fn cleanupStateAdmittedByMir"),
        ("src/backend_cleanup.zig", "fn deferCleanupEmissionRangeValid"),
        ("src/backend_cleanup.zig", "fn deferCleanupEmissionCount"),
        ("src/backend_cleanup.zig", "fn cleanupRefAtEmissionIndex"),
        ...
        ("src/backend_cleanup.zig", "fn cleanupEdgeTableValidWithMirEdges"),
        ("src/backend_cleanup.zig", "fn cleanupEdgeRefsAdmittedByCleanupCfg"),
        ("src/backend_cleanup.zig", "pub const CleanupEdgePlan"),
        ("src/backend_cleanup.zig", "fn buildCleanupEdgeTableFromCursor"),
        ...
        ("src/backend_cleanup.zig", "pub const CleanupStateSnapshot"),
        ("src/backend_cleanup.zig", "pub fn capture(self: *const CleanupState"),
        ("src/backend_cleanup.zig", "pub fn restore(self: *CleanupState"),
        ("src/backend_cleanup.zig", "pub const AutoDropStackDecision"),
        ("src/backend_cleanup.zig", "pub fn registerAutoDropLocalCleanup"),
        ("src/backend_cleanup.zig", "fn autoDropLocalCleanupFromMirCfg"),
        ...
        ("src/backend_cleanup.zig", "fn cleanupRemovalRefFromMirCancellation"),
        ("src/backend_cleanup.zig", "fn cleanupRemovalRefFromMirExplicitDropAction"),
        ("src/backend_cleanup.zig", "fn explicitDropActionEntryFromMirPlan"),
        ("src/backend_cleanup.zig", "fn localHasConsumingAutoDropResourceEvent"),
        ("src/backend_cleanup.zig", "fn typeSymbolHasDropGlue"),
        ("src/backend_cleanup.zig", "fn dropGlueReleaseFunctionExists"),
        ("src/backend_cleanup.zig", "fn cleanupCancellationEntryFromMirPlan"),
        ("src/backend_cleanup.zig", "fn localNameForValueId"),
        ("src/backend_cleanup.zig", "fn sourceMatches"),
        ("src/backend_cleanup.zig", "pub fn registerDeferredExplicitDropCleanup"),
        ("src/backend_cleanup.zig", "fn explicitDropLocalCleanupFromMirAction"),
        ("src/backend_cleanup.zig", "pub fn registerOrdinaryDeferCleanup"),
        ...
        ("src/backend_cleanup.zig", "entries: std.ArrayList(CleanupRef)"),
        ("src/backend_cleanup.zig", "fn removeAutoDrop(self: *CleanupState"),
