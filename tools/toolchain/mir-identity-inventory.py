...
def main() -> int:
    ...
    for path, needle in (
        ...
        ("src/backend_cleanup.zig", "pub const CleanupStackMark"),
        ("src/backend_cleanup.zig", "pub const CleanupState"),
        ("src/backend_cleanup.zig", "pub fn currentCleanupStackMark"),
        ("src/backend_cleanup.zig", "pub fn rootCleanupStackMark"),
        ("src/backend_cleanup.zig", "pub fn cleanupStackMarkIndex"),
        ("src/backend_cleanup.zig", "pub fn restoreDeferCleanupStackToMark"),
        ("src/backend_cleanup.zig", "pub fn deferCleanupStackRefsValid"),
        ("src/backend_cleanup.zig", "pub fn deferCleanupStackAdmittedByMir"),
        ...
        ("src/backend_cleanup.zig", "fn buildTransitionalCleanupEdgeTable"),
