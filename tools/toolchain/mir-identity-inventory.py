...
def main() -> int:
    ...
    for path, needle in (
        ...
        ("src/mir_ownership_authority.zig", "pub const DropGlueDeclArtifact"),
        ...
        ("src/backend_cleanup.zig", "callee: ast_bridge.Expr"),
        ("src/backend_cleanup.zig", "callee_span: ast_bridge.Span"),
        ("src/backend_cleanup.zig", "type_args: []const ast_bridge.TypeExpr"),
        ("src/backend_cleanup.zig", "args: []const ast_bridge.Expr"),
