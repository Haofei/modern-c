...
def main() -> int:
    ...
    for path, needle in (
        ...
        ("src/backend_cleanup.zig", "call_free_expr: ast.Expr"),
        ("src/backend_cleanup.zig", "pub fn ordinaryDeferCallFreeExprSupported"),
        ...
        ("docs/compiler-production-readiness.md", "C/LLVM cleanup cancellation requires source-matched MIR decisions"),
