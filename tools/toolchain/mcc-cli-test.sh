...
assert_stdout_contains "mcc inspect-hir <file.mc>" "--help inspect-hir command"
assert_stdout_contains "mcc verify-inspect-hir <file.mc>" "--help verify-inspect-hir command"
...
assert_stdout_contains "mcc inspect-ir <file.mc>" "--help inspect-ir command"
...
assert_stdout_contains "Legacy aliases remain accepted:" "--help legacy inspection aliases"
