...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/early_declaration_metadata.zig": {
        ...
        "const_fns: []const ast.FnDecl": 1,
        "const_globals: []const ast.GlobalDecl": 1,
    ...
    "src/lower_c.zig": {
        ...
        "SourceMapRows.collectFromArtifacts(allocator, early_metadata.decl_artifacts, early_metadata.decl_origins)": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "for (artifacts.const_fns) |fn_decl|": 1,
