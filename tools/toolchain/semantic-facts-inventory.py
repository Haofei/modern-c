...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        # Admitted global plans now take the checked-fact path and do not
        # retain a GlobalArtifact. Aggregate literals, relocations, and extern
        # globals remain explicitly transitional until their facts are complete.
        "const checked = globalByName(typed_mir, global.name.text);": 1,
        "if (checked == null or typed_mir.checkedGlobalInitializer(checked.?) == null) {": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "try ctx.preRegisterTypeDeclsFromArtifacts(early_metadata);": 0,
        "try ctx.preRegisterTypeDeclsFromArtifacts(early_metadata, comptime_declarations);": 1,
        ...
        "fn preRegisterTypeDeclsFromArtifacts(self: *LlvmEmitter, artifacts: CodegenDeclArtifacts) !void": 0,
        "fn preRegisterTypeDeclsFromArtifacts(": 1,
        ...
        "fn dynVtableLlvmType(self: *LlvmEmitter, trait: declaration_artifacts.TraitDeclArtifact)": 0,
        "fn dynDispatchTrait(self: *LlvmEmitter, callee: ast_bridge.Expr) ?ast_bridge.TraitDecl": 0,
        "fn dynDispatchTrait(self: *LlvmEmitter, callee: ast_bridge.Expr) ?declaration_artifacts.TraitDeclArtifact": 0,
        "fn emitDynDispatch(self: *LlvmEmitter, call: anytype, trait: ast_bridge.TraitDecl)": 0,
        "fn emitDynDispatch(self: *LlvmEmitter, call: anytype, trait: declaration_artifacts.TraitDeclArtifact)": 0,
        ...
        "try self.collectTypeAlias(alias)": 0,
        ...
        "try ctx.collectFunctionGlobalAndTraitArtifacts();": 0,
        "fn collectFunctionGlobalAndTraitArtifacts(self: *LlvmEmitter) !void": 0,
        ...
        "const call_kind = self.mirCallTargetKindAt(call.callee.*.span);": 1,
        "call_kind == .bind": 2,
