...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c.zig": {
        ...
        'const early_declaration_metadata = @import("early_declaration_metadata.zig")': 1,
        ...
        "early_metadata: early_declaration_metadata.EarlyDeclarationArtifacts": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "pub fn collectEarlyDeclarationMetadata(self: *CEmitter, artifacts: early_declaration_metadata.EarlyDeclarationArtifacts) !void": 1,
        ...
        "early_declaration_metadata.EarlyDeclarationArtifacts": 9,
        ...
        "pub fn collectDeclArtifacts(self: *CEmitter, artifacts: early_declaration_metadata.EarlyDeclarationArtifacts) anyerror!void": 1,
    ...
    "src/lower_c_module.zig": {
        ...
        "pub fn collect(emitter: anytype, early_metadata: early_declaration_metadata.EarlyDeclarationArtifacts)": 1,
        "pub fn emit(emitter: anytype, early_metadata: early_declaration_metadata.EarlyDeclarationArtifacts)": 1,
    },
    "src/lower_c_convert.zig": {
    ...
    "src/lower_llvm.zig": {
        ...
        "fn preRegisterTypeDeclsFromArtifacts(self: *LlvmEmitter, artifacts: early_declaration_metadata.EarlyDeclarationArtifacts) !void": 1,
