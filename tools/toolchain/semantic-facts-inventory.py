...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "legacy_backend_syntax.LegacyDeclarationSlice": 6,
        ...
        "try emitter.collectModule(legacy_backend_syntax.LegacyDeclarationSlice.forDecls(module.decls));": 2,
        "for (decls) |decl|": 2,
    ...
    "src/lower_c_module.zig": {
        "const decls = declarations.declsForEarlyDeclarationScan();": 0,
        "const early_metadata = declarations.earlyDeclarationMetadata();": 1,
        ...
        "pub fn collect(emitter: anytype, declarations: legacy_backend_syntax.LegacyDeclarationSlice)": 1,
        "pub fn emit(emitter: anytype, declarations: legacy_backend_syntax.LegacyDeclarationSlice)": 1,
    },
    "src/lower_c_convert.zig": {
