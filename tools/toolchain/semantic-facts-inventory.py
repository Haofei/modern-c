...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "type_decl_artifacts: []const TypeDeclArtifact": 1,
        "pub const TypeDeclArtifact = union(enum)": 1,
        ...
        "try type_decl_artifacts.append(allocator, .{ .type_alias = alias })": 1,
        "try type_decl_artifacts.append(allocator, .{ .struct_decl = struct_decl })": 1,
        "try type_decl_artifacts.append(allocator, .{ .enum_decl = enum_decl })": 1,
        "try type_decl_artifacts.append(allocator, .{ .union_decl = union_decl })": 1,
        "try type_decl_artifacts.append(allocator, .{ .packed_bits_decl = packed_bits_decl })": 1,
        "try type_decl_artifacts.append(allocator, .{ .overlay_union_decl = overlay_union })": 1,
        "body: ast.Block": 0,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "for (artifacts.type_decl_artifacts) |artifact| switch (artifact)": 2,
    ...
    "src/lower_llvm.zig": {
        ...
        "type_decl_artifacts: []const declaration_artifacts.TypeDeclArtifact": 1,
        ...
        "for (self.type_decl_artifacts) |artifact| switch (artifact)": 1,
        "for (artifacts.type_alias_artifacts) |alias|": 0,
        "for (artifacts.enum_artifacts) |enum_decl|": 0,
        "for (artifacts.union_artifacts) |union_decl|": 0,
        "for (artifacts.packed_bits_artifacts) |packed_bits|": 0,
        "for (artifacts.struct_artifacts) |struct_decl|": 0,
        "for (artifacts.type_decl_artifacts) |artifact| switch (artifact)": 1,
