...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "decl_artifacts: []const GlobalArtifact": 2,
        ...
        "try decl_artifacts.append(allocator, GlobalArtifact.fromDecl(global, checked));": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "for (artifacts.decl_artifacts) |global|": 2,
    ...
    "src/lower_llvm.zig": {
        ...
        "for (self.codegen_artifacts.decl_artifacts) |global|": 2,
