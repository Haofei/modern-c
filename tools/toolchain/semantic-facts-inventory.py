...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "pub fn collectEarlyDeclarationMetadata(self: *CEmitter, artifacts: declaration_artifacts.CodegenDeclarationArtifacts) !void": 1,
        ...
        "declaration_artifacts.CodegenDeclarationArtifacts": 8,
        ...
        "pub fn collectDeclArtifacts(self: *CEmitter, artifacts: declaration_artifacts.CodegenDeclarationArtifacts) anyerror!void": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView": 0,
        "early_metadata: declaration_artifacts.EarlyDeclarationArtifacts": 0,
        "early_metadata: declaration_artifacts.CodegenDeclarationArtifacts": 1,
        "early_metadata.syntaxForEarlyDeclarationScan()": 0,
        "early_metadata.moduleForComptimeEvaluation()": 0,
        "early_metadata.declsForEarlyDeclarationScan()": 0,
        ...
        "if (function.backend_name) |name| try self.backend_names.put(function.name.text, name);": 1,
        ".error_from = function.has_error_from": 0,
        ".error_from = sig.error_from": 1,
        ...
        "fn preRegisterTypeDeclsFromArtifacts(self: *LlvmEmitter, artifacts: declaration_artifacts.CodegenDeclarationArtifacts) !void": 1,
