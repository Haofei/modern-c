...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "fn directCallResultTypeForInferredLocal(": 1,
        ...
        "const array_ty = self.directCallResultTypeForInferredLocal(initializer, isArrayDirectCallResultType) orelse return false;": 1,
        ...
        "const slice_ty = self.directCallResultTypeForInferredLocal(initializer, isSliceDirectCallResultType) orelse return false;": 1,
        "fn isEnumDirectCallResultType(": 1,
        "const enum_ty = self.enumReturnTypeForExpr(initializer) orelse return false;": 0,
        "const enum_ty = self.directCallResultTypeForInferredLocal(initializer, isEnumDirectCallResultType) orelse return false;": 1,
        ...
        "self.directCallResultTypeForInferredLocal(initializer, isTaggedUnionDirectCallResultType) orelse": 1,
        ...
        "const result_ty = self.directCallResultTypeForInferredLocal(initializer, isResultDirectCallResultType) orelse return false;": 1,
        ...
        "const nullable_ty = self.directCallResultTypeForInferredLocal(initializer, isNullableDirectCallResultType) orelse return false;": 1,
