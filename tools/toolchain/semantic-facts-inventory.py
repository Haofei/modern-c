...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    "src/backend.zig": {
        ...
        "pub const LegacyDeclarationSlice = legacy_backend_syntax.LegacyDeclarationSlice": 1,
        "pub const SourceMapMechanicsView = legacy_backend_syntax.SourceMapMechanicsView": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "backend_mod.LegacyDeclarationSlice": 6,
        "try emitter.collectModule(module);": 0,
        "try emitter.collectModule(backend_mod.LegacyDeclarationSlice.forLegacySyntax(module));": 0,
        "try emitter.collectModule(backend_mod.LegacyDeclarationSlice.forDecls(module.decls));": 2,
        "for (decls) |decl|": 2,
    ...
    "src/lower_c_module.zig": {
        ...
        "collectDropGlueFactsFromMir": 0,
        "pub fn collect(emitter: anytype, declarations: backend.LegacyDeclarationSlice)": 1,
        "pub fn emit(emitter: anytype, declarations: backend.LegacyDeclarationSlice)": 1,
    },
    "src/lower_c_convert.zig": {
