...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_llvm.zig": {
        ...
        "if (function.signature.backend_name) |name| try self.backend_names.put(function.signature.name.text, name);": 0,
        ".error_from = function.has_error_from": 0,
        ".error_from = sig.error_from": 0,
        ".error_from = fact.error_from": 1,
        ...
        "if (eval.comptimeTypeBitWidth(ty)) |bits| try self.const_global_widths.put(sig.name.text, bits);": 0,
        "if (eval.comptimeTypeBitWidth(ty)) |bits| try self.const_global_widths.put(name, bits);": 0,
        ...
        "eval.collectConstGlobalsFromDeclarationsWithOptions(allocator, comptime_declarations, &ctx.const_fns": 0,
        "comptime_module: ast.Module": 0,
        "comptime_decls: []const ast.Decl": 0,
        "comptime_declarations: eval.ComptimeDeclarations": 0,
        ".comptime_module = comptime_module": 0,
        ".comptime_decls = decls": 0,
        ".comptime_declarations = comptime_declarations": 0,
        "scope.module = self.comptime_module": 0,
        "scope.decls = self.comptime_decls": 0,
        "scope.declarations = self.comptime_declarations": 0,
        ...
        "try ctx.preRegisterTypeDeclsFromArtifacts(early_metadata, comptime_declarations);": 0,
        ...
        "fn preRegisterTypeDeclsFromArtifacts(": 0,
        "try ctx.collectNonStructTypeArtifacts(module);": 0,
        "try ctx.collectNonStructTypeArtifacts();": 0,
        "fn collectNonStructTypeArtifacts(self: *LlvmEmitter, module: ast.Module) !void": 0,
        "fn collectNonStructTypeArtifacts(self: *LlvmEmitter) !void": 0,
        "try self.decl_artifacts.append(self.allocator, decl);": 0,
        "for (self.decl_artifacts.items) |decl|": 0,
        "decl_artifacts: []const early_declaration_metadata.DeclArtifact": 0,
        ".codegen_artifacts = early_metadata": 1,
        "for (self.codegen_artifacts.decl_artifacts) |artifact|": 0,
        "for (self.codegen_artifacts.decl_artifacts) |global|": 0,
        ...
        "fn collectGlobal(self: *LlvmEmitter, global: declaration_artifacts.GlobalArtifact) !void": 0,
        "fn emitGlobal(self: *LlvmEmitter, global: ast_bridge.GlobalDecl) !void": 0,
        "fn emitGlobal(self: *LlvmEmitter, global: declaration_artifacts.GlobalArtifact) !void": 0,
        ...
        "try ctx.collectStructArtifacts();": 0,
        "fn collectStructArtifacts(self: *LlvmEmitter) !void": 0,
        "try ctx.collectStruct(struct_decl)": 0,
        "try self.collectStruct(struct_decl)": 0,
        ...
        "try self.collectOverlayUnion(overlay_union)": 0,
        "try self.collectTaggedUnion(union_decl)": 0,
        ...
        "try self.collectFunctionArtifact(function)": 0,
        "try ctx.collectCallableEmissionFacts()": 1,
        "fn collectCallableEmissionFacts(self: *LlvmEmitter) !void": 1,
        "try self.collectGlobal(global)": 0,
        ...
        "fn emitExternFunction(self: *LlvmEmitter, function: anytype)": 0,
        "fn emitExternFunction(self: *LlvmEmitter, fact: mir.CallableEmissionFact)": 1,
        "try self.function_decl_artifacts.append(self.allocator": 0,
        "for (self.global_decl_artifacts.items) |global| try self.emitGlobal(global);": 0,
        "for (self.function_decl_artifacts.items) |artifact|": 0,
        ...
        "mirTargetTypeFactAt(.explicit_cast_source": 1,
        "mirTargetTypeFactAt(.explicit_cast_target": 2,
        "mirTargetTypeFactAt(.view_const_narrow_source": 1,
        "mirTargetTypeFactAt(.view_const_narrow_target": 1,
        ...
        "fn atomicInitPayloadTypeAt(": 1,
        "mirHasCallTargetKindAt(.atomic_init": 1,
        ...
        "self.current_function = global.name.text;": 0,
        "self.current_function = sig.name.text;": 0,
        "if (span.line == 0 or span.column == 0) return null;": 0,
        "if (!isSourceSpan(span)) return null;": 0,
