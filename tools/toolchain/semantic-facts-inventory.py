...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/codegen_request.zig": {
        ...
        "declaration_artifacts: declaration_artifacts.EarlyDeclarationArtifacts": 1,
        "source_map_rows: source_map_rows.SourceMapRows": 0,
        "source_map_artifacts: []const declaration_artifacts.SourceMapArtifact": 1,
    ...
    "src/main.zig": {
        ...
        "driver_codegen_inputs.DeclarationArtifacts": 6,
    ...
    "src/declaration_artifacts.zig": {
        ...
        "fn collectFromSyntaxDecls(allocator: std.mem.Allocator, syntax_items: []const ast.Decl) !EarlyDeclarationArtifacts": 1,
        "pub fn collectFromResolvedDecls(": 1,
        "pub fn collectFromModuleDeclsForTests(": 1,
        ...
        "pub fn comptimeFnDeclFromArtifact(function: FunctionArtifact) ast.FnDecl": 1,
        "function_artifacts: []const FunctionArtifact": 1,
        ...
        "fn globalDeclFromArtifact(global: GlobalArtifact) ast.GlobalDecl": 1,
        "global_artifacts: []const ast.GlobalDecl": 0,
        "global_artifacts: []const GlobalArtifact": 1,
        "global.toDecl()": 0,
        "globalDeclFromArtifact(global)": 1,
        ...
        "try function_artifacts.append(allocator, FunctionArtifact.fromDecl(fn_decl, decl.attrs, false))": 1,
        "try function_artifacts.append(allocator, FunctionArtifact.fromDecl(fn_decl, decl.attrs, true))": 1,
        "try global_artifacts.append(allocator, global)": 0,
        "try global_artifacts.append(allocator, .{ .global = global })": 0,
        "try global_artifacts.append(allocator, GlobalArtifact.fromDecl(global))": 1,
        ...
        "trait_decl_artifacts: []const TraitDeclArtifact": 1,
        "impl_trait_artifacts: []const ImplTraitArtifact": 1,
        ...
        "try trait_decl_artifacts.append(allocator, TraitDeclArtifact.fromDecl(trait_decl))": 1,
        "try impl_trait_artifacts.append(allocator, ImplTraitArtifact.fromDecl(impl_trait))": 1,
        ...
        "type_alias_artifacts: []const ast.TypeAlias": 1,
        "struct_artifacts: []const ast.StructDecl": 1,
        "enum_artifacts: []const ast.EnumDecl": 1,
        "union_artifacts: []const ast.UnionDecl": 1,
        "packed_bits_artifacts: []const ast.PackedBitsDecl": 1,
        "overlay_union_artifacts: []const ast.OverlayUnionDecl": 1,
        "try type_artifacts.append": 0,
        "try type_alias_artifacts.append(allocator, alias)": 1,
        "try struct_artifacts.append(allocator, struct_decl)": 1,
        "try enum_artifacts.append(allocator, enum_decl)": 1,
        "try union_artifacts.append(allocator, union_decl)": 1,
        "try packed_bits_artifacts.append(allocator, packed_bits_decl)": 1,
        "try overlay_union_artifacts.append(allocator, overlay_union)": 1,
        "body: ast.Block": 0,
    ...
    "src/driver_codegen_inputs.zig": {
        ...
        "DeclarationArtifacts.collectFromResolvedDecls(session.allocator, resolved_decls)": 1,
        "DeclarationArtifacts.collectFromResolvedDecls(session.allocator, fallback_decls)": 1,
    },
    "src/lower_llvm_prelude.zig": {
    ...
    "src/lower_c.zig": {
        ...
        "early_metadata: declaration_artifacts.EarlyDeclarationArtifacts": 1,
    ...
    "src/ownership_facts.zig": {
        ...
        "test \"auto-drop release shape is independent of cleanup state lookup\"": 0,
    ...
    "src/mir_ownership_authority.zig": {
        ...
        "pub const DeferredCleanup": 0,
        "emit_auto_drop_cleanup: AutoDropLocalCleanup": 0,
        ...
        "mir.buildOwnershipCleanupEdgeTable": 0,
        ...
        "mir.ownershipLocalHasConsumingResourceEvent": 0,
        "mir.ownershipLocalHasAutoDropResourceEvent": 0,
        "pub fn removeAutoDropCleanupForLocalName": 0,
        "remove_auto_drop_local": 0,
        "pub const AutoDropCleanupKey": 0,
        "remove_auto_drop: AutoDropCleanupKey": 0,
        "remove_auto_drop: OwnershipCleanupRemovalRef": 0,
        ...
        "pub fn deferredExplicitDropCleanupDecision": 0,
        ...
        "ast_query.dropPointerReleaseParamTypeName(artifact.toDecl())": 0,
        "pub fn dropPointerReleaseParamTypeNameFromParams(params: []const ast.Param)": 1,
        "pub fn dropGlueFactsMatchDeclArtifacts": 1,
        "pub fn dropGlueDeclArtifactMatches": 0,
        "fn dropGlueDeclArtifactMatches": 1,
        "pub fn directMovedLocalName": 0,
        "pub fn moveAutoDropCancellationDecision": 0,
        "pub fn explicitDropCancellationDecision": 0,
        "fn removalRefForCancellationEntry": 0,
        "fn directMovedLocalName": 0,
        "ast_query.directMovedLocalName(expr)": 0,
        "ast_query.dropPointerLocalReleaseCall(expr)": 1,
        "test \"auto-drop cleanup state removal uses the latest matching local\"": 0,
    ...
    "src/backend_cleanup.zig": {
        ...
        "defer_span": 0,
        "pub fn deferCleanupRefsValid": 0,
        "fn deferCleanupRefsValid": 0,
        "pub fn cleanupStateAdmittedByMir": 0,
        "pub fn deferCleanupEmissionRangeValid": 0,
        "pub fn deferCleanupEmissionCount": 0,
        "pub fn deferCleanupAtEmissionIndex": 0,
        "fn deferCleanupEmissionRangeValid": 0,
        "fn deferCleanupEmissionCount": 0,
        "fn deferCleanupAtEmissionIndex": 0,
        "fn cleanupRefAtEmissionIndex": 0,
        "pub const CleanupEdgeKind": 1,
        "pub const CleanupRef": 1,
        "pub const CleanupEdge = struct": 0,
        "pub const CleanupEdgeTable": 0,
        "pub fn cleanupEdgeTableValid": 0,
        "fn cleanupEdgeTableValid(": 0,
        "fn cleanupEdgeTableValidWithMirEdges": 0,
        "fn cleanupEdgeDeferRefsAdmittedByMir": 0,
        "fn cleanupEdgeRefsAdmittedByCleanupCfg": 0,
        "pub const CleanupEdgePlan": 1,
        "pub fn buildTransitionalCleanupEdgeTable": 0,
        "fn buildTransitionalCleanupEdgeTable": 0,
        "fn buildCleanupEdgeTableFromCursor": 0,
        "pub fn buildCleanupEdgePlan": 1,
        "pub fn cleanupEdgePlanFromTable": 0,
        "pub fn cleanupEdgeFor": 0,
        "pub fn cleanupRef": 0,
        "pub const DeferCleanupStackSnapshot": 0,
        "pub const CleanupStateSnapshot": 0,
        "pub const CleanupStackMark": 0,
        "pub const CleanupCursor": 0,
        "pub const CleanupState = struct": 0,
        "pub fn captureDeferCleanupStack": 0,
        "pub fn currentCleanupStackMark": 0,
        "pub fn rootCleanupStackMark": 0,
        "pub fn rootCleanupCursor": 0,
        "pub fn cleanupStackMarkIndex": 0,
        "pub fn cleanupCursorIndex": 0,
        "pub fn restoreDeferCleanupStack(": 0,
        "pub fn restoreDeferCleanupStackLength": 0,
        "pub fn restoreDeferCleanupStackToMark": 0,
        "pub fn restoreToCursor": 0,
        "pub fn capture(self: *const CleanupState": 0,
        "pub fn restore(self: *CleanupState": 0,
        "pub const AutoDropStackDecision": 1,
        "pub fn registerAutoDropLocalCleanup": 0,
        "pub fn validateFunctionCleanupAuthority": 1,
        "mir_ownership_authority.autoDropLocalRegistrationDecision": 0,
        "fn autoDropLocalCleanupFromMirEdge": 0,
        "fn autoDropLocalCleanupFromMirCfg": 0,
        "fn typeOwnershipFactForTypeName": 0,
        "fn valueIdForLocal": 0,
        "pub fn cancelAutoDropForMove(": 0,
        "pub fn cancelAutoDropForExplicitDrop": 0,
        ...
        "pub fn registerOrdinaryDirectDeferCleanup": 0,
        "pub fn registerOrdinaryCallTargetDeferCleanup": 0,
        "pub fn registerOrdinaryBlockDeferCleanup": 0,
        "fn appendValidatedCleanup": 0,
        "fn cancelAutoDropWithDecision": 0,
        "test \"defer cleanup state snapshot restores full contents\"": 0,
        "test \"cleanup state snapshot restores full contents\"": 0,
        "fn deferCleanupRefAfter": 0,
        "fn deferCleanupSourceOrder": 0,
        "test \"defer cleanup state refs must be valid ordered and unique\"": 0,
        "call: ast.Expr": 0,
        "pub const DeferredCleanup": 0,
        "raw_expr: ast.Expr": 0,
        ...
        "block: DeferBlockCleanup": 0,
        "direct_call: OrdinaryDeferCallCleanup": 0,
        "call_target: OrdinaryDeferCallCleanup": 0,
        "call_target: CallTargetDeferCleanup": 0,
        "auto_drop: mir_ownership_authority.AutoDropLocalCleanup": 0,
        "explicit_drop: mir_ownership_authority.AutoDropLocalCleanup": 0,
        "auto_drop: mir_ownership_authority.OwnershipCleanupActionRef": 0,
        "explicit_drop: mir_ownership_authority.OwnershipCleanupActionRef": 0,
        "entries: std.ArrayList(CleanupRef)": 0,
        "pub fn removeAutoDropCleanupForLocalName": 0,
        "pub fn removeAutoDropCleanup(": 0,
        "fn removeAutoDropCleanup(": 0,
        "fn removeAutoDrop(self: *CleanupState": 0,
        "mir_ownership_authority.AutoDropCleanupKey": 0,
        "mir_ownership_authority.OwnershipCleanupRemovalRef": 0,
        "fn autoDropCleanupMatchesRef": 0,
        "fn cleanupRemovalRefFromMirCancellation": 0,
        "fn cleanupRemovalRefFromMirExplicitDropAction": 0,
        "fn explicitDropActionEntryFromMirPlan": 1,
        "fn localHasConsumingCancellationEvent": 0,
        "fn localHasConsumingAutoDropResourceEvent": 0,
        "fn typeSymbolHasDropGlue": 0,
        "fn dropGlueReleaseFunctionExists": 1,
        "fn cleanupCancellationEntryFromMirPlan": 0,
        ...
        "cleanup.cleanup_action_index != ref.cleanup_action_index": 0,
        "test \"auto-drop cleanup state removal uses typed local identity\"": 0,
        "test \"auto-drop cleanup state removal uses typed local identity\"": 0,
    },
    "src/sema.zig": {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "pub fn collectEarlyDeclarationMetadata(self: *CEmitter, artifacts: declaration_artifacts.EarlyDeclarationArtifacts) !void": 1,
        ...
        "const DeferredCleanup = backend_cleanup.DeferredCleanup": 0,
        ...
        "defer_stack: std.ArrayList(DeferredCleanup)": 0,
        "cleanup_state: backend_cleanup.CleanupState": 0,
        "mir.hasDeferCleanupAtSource": 0,
        "mir.directDeferCallCleanupAtSource": 0,
        "mir.callTargetDeferCleanupAtSource": 0,
        "mir.deferCleanupRefAtSource": 0,
        "mir.deferCleanupRefValid": 1,
        "mir.directDeferCallCleanupForRef": 0,
        "mir.callTargetDeferCleanupForRef": 0,
        ...
        "backend_cleanup.cleanupStateAdmittedByMir": 0,
        "backend_cleanup.deferCleanupRefsValid": 0,
        ...
        "backend_cleanup.captureDeferCleanupStack": 0,
        "backend_cleanup.restoreDeferCleanupStack(": 0,
        "backend_cleanup.restoreDeferCleanupStackToMark": 0,
        "self.cleanup_state.capture(self.allocator)": 0,
        "self.cleanup_state.restore(saved_cleanup_state)": 0,
        "self.cleanup_state.restoreToCursor(": 0,
        "backend_cleanup.restoreDeferCleanupStackLength": 0,
        "fn restoreDeferStackSnapshot": 0,
        "self.defer_stack.items.len = ": 0,
        "fn validateCleanupState": 0,
        ...
        "backend_cleanup.cancelAutoDropForMove": 0,
        "backend_cleanup.cancelAutoDropForExplicitDrop": 0,
        ...
        "ast_query.dropPointerReleaseParamTypeName(fn_decl)": 0,
        "type_bridge.dropPointerReleaseParamTypeName(fn_decl)": 0,
        "mir_ownership_authority.dropPointerReleaseParamTypeNameFromParams(function.params)": 1,
        ...
        "declaration_artifacts.EarlyDeclarationArtifacts": 9,
        ...
        "pub fn collectDeclArtifacts(self: *CEmitter, artifacts: declaration_artifacts.EarlyDeclarationArtifacts) anyerror!void": 1,
        ...
        "for (artifacts.type_alias_artifacts) |alias|": 2,
        "for (artifacts.struct_artifacts) |struct_decl|": 2,
        "for (artifacts.enum_artifacts) |enum_decl|": 2,
        "for (artifacts.union_artifacts) |union_decl|": 2,
        "for (artifacts.packed_bits_artifacts) |packed_bits|": 1,
        "for (artifacts.overlay_union_artifacts) |overlay_union|": 1,
        "for (artifacts.callable_value_artifacts) |artifact| switch (artifact)": 0,
        "try self.collectFunctionArtifacts(artifacts.function_artifacts);": 1,
        "try self.collectGlobalArtifacts(artifacts.global_artifacts);": 1,
        "fn collectFunctionArtifacts(self: *CEmitter, artifacts: []const declaration_artifacts.FunctionArtifact) anyerror!void": 1,
        ...
        "fn collectGlobalArtifacts(self: *CEmitter, artifacts: []const declaration_artifacts.GlobalArtifact) anyerror!void": 1,
        "fn collectCallableValueArtifacts": 0,
        "try self.collectTraitArtifacts(artifacts.trait_artifacts);": 0,
        "try self.collectTraitArtifacts(artifacts.trait_decl_artifacts, artifacts.impl_trait_artifacts);": 1,
        "fn collectTraitArtifacts(self: *CEmitter, artifacts: []const declaration_artifacts.TraitArtifact) anyerror!void": 0,
        "trait_artifacts: []const declaration_artifacts.TraitDeclArtifact": 1,
        "impl_artifacts: []const declaration_artifacts.ImplTraitArtifact": 1,
        ...
        "for (trait_artifacts) |trait_decl|": 1,
        "try self.trait_decls.put(trait_decl.name.text, trait_decl.toDecl())": 0,
        "try self.trait_decls.put(trait_decl.name.text, trait_decl)": 1,
        "for (impl_artifacts) |impl_trait|": 1,
        "fn collectTypeArtifactsFromArtifacts(self: *CEmitter, artifacts: []const declaration_artifacts.TypeArtifact) anyerror!void": 0,
        "fn collectTypeArtifactsFromArtifacts(self: *CEmitter, artifacts: declaration_artifacts.EarlyDeclarationArtifacts) anyerror!void": 1,
        "FunctionDeclArtifact.fromDecl(fn_decl, attrs, is_extern)": 0,
        "functionDeclArtifact(function)": 1,
        "artifact.fn_decl": 0,
        "const fn_decl = artifact.toDecl();": 0,
        "fn emitFunctionPrototype(self: *CEmitter, fn_decl: anytype)": 1,
        "fn emitFunctionForwardDecl(self: *CEmitter, fn_decl: anytype)": 1,
        "fn emitFunction(self: *CEmitter, fn_decl: anytype": 1,
        "fn emitFunctionBody(self: *CEmitter, fn_decl: anytype": 1,
        ...
        "global_decl_artifacts: std.ArrayList(declaration_artifacts.GlobalArtifact)": 1,
    ...
    "src/lower_c_module.zig": {
        "const decls = declarations.declsForEarlyDeclarationScan();": 0,
        "const early_metadata = declarations.earlyDeclarationMetadata();": 0,
        "const decls = early_metadata.declsForEarlyDeclarationScan();": 0,
        "const decls = early_metadata.declsForLegacyArtifactEnumeration();": 0,
        "emitter.setComptimeDeclarations(.{": 0,
        "try emitter.collectEarlyDeclarationMetadata(early_metadata);": 1,
        "try emitter.collectDeclArtifacts(early_metadata);": 1,
        "collectDropGlueFactsFromMir": 0,
        "pub fn collect(emitter: anytype, declarations: backend.LegacyDeclarationSlice)": 0,
        "pub fn emit(emitter: anytype, declarations: backend.LegacyDeclarationSlice)": 0,
        "pub fn collect(emitter: anytype, declarations: legacy_backend_syntax.LegacyDeclarationSlice)": 0,
        "pub fn emit(emitter: anytype, declarations: legacy_backend_syntax.LegacyDeclarationSlice)": 0,
        "pub fn collect(emitter: anytype, early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView)": 0,
        "pub fn emit(emitter: anytype, early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView)": 0,
        "pub fn collect(emitter: anytype, early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView)": 0,
        "pub fn emit(emitter: anytype, early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView)": 0,
        "pub fn collect(emitter: anytype, early_metadata: declaration_artifacts.EarlyDeclarationArtifacts)": 1,
        "pub fn emit(emitter: anytype, early_metadata: declaration_artifacts.EarlyDeclarationArtifacts)": 1,
    },
    "src/lower_c_convert.zig": {
    ...
    "src/lower_llvm.zig": {
        ...
        "for (function.attrs) |attr| switch (attr.kind)": 1,
        ".backend_name => |name| try self.backend_names.put(fn_decl.name.text, name)": 0,
        ".backend_name => |name| try self.backend_names.put(function.name.text, name)": 1,
        ...
        "fn preRegisterTypeDeclsFromArtifacts(self: *LlvmEmitter, artifacts: declaration_artifacts.EarlyDeclarationArtifacts) !void": 1,
        ...
        ".decl_artifacts = early_metadata.decl_artifacts": 0,
        "for (self.decl_artifacts) |artifact|": 0,
        "for (self.type_artifacts) |artifact|": 0,
        "type_alias_artifacts: []const ast_bridge.TypeAlias": 1,
        "struct_artifacts: []const ast_bridge.StructDecl": 1,
        "enum_artifacts: []const ast_bridge.EnumDecl": 1,
        "union_artifacts: []const ast_bridge.UnionDecl": 1,
        "packed_bits_artifacts: []const ast_bridge.PackedBitsDecl": 1,
        "overlay_union_artifacts: []const ast_bridge.OverlayUnionDecl": 1,
        "for (self.packed_bits_artifacts) |packed_bits|": 1,
        "for (self.overlay_union_artifacts) |overlay_union|": 1,
        "for (self.union_artifacts) |union_decl|": 1,
        "for (self.type_alias_artifacts) |alias|": 1,
        "for (self.enum_artifacts) |enum_decl|": 1,
        "for (artifacts.type_alias_artifacts) |alias|": 1,
        "for (artifacts.enum_artifacts) |enum_decl|": 1,
        "for (artifacts.union_artifacts) |union_decl|": 1,
        "for (artifacts.packed_bits_artifacts) |packed_bits|": 1,
        "for (artifacts.struct_artifacts) |struct_decl|": 1,
        "for (self.callable_value_artifacts) |artifact|": 0,
        "for (self.function_artifacts) |function|": 1,
        "const fn_decl = function.toDecl();": 0,
        "const fn_decl = declaration_artifacts.comptimeFnDeclFromArtifact(function);": 1,
        "for (self.global_artifacts) |global|": 1,
        "global_artifacts: []const ast_bridge.GlobalDecl": 0,
        "global_artifacts: []const declaration_artifacts.GlobalArtifact": 1,
        ...
        "trait_decl_artifacts: []const declaration_artifacts.TraitDeclArtifact": 1,
        "impl_trait_artifacts: []const declaration_artifacts.ImplTraitArtifact": 1,
        "trait_decls: std.StringHashMap(ast_bridge.TraitDecl)": 0,
        "trait_decls: std.StringHashMap(declaration_artifacts.TraitDeclArtifact)": 1,
        "for (self.trait_decl_artifacts) |trait_decl|": 1,
        "try self.trait_decls.put(trait_decl.name.text, trait_decl.toDecl())": 0,
        "try self.trait_decls.put(trait_decl.name.text, trait_decl)": 1,
        "for (self.impl_trait_artifacts) |impl_trait|": 1,
        ...
        "llvmFunctionDeclArtifact(function)": 1,
        "artifact.fn_decl": 0,
        "const fn_decl = artifact.toDecl();": 0,
        "fn emitFunction(self: *LlvmEmitter, fn_decl: anytype": 1,
        "fn emitExternFunction(self: *LlvmEmitter, fn_decl: anytype)": 1,
        "try self.function_decl_artifacts.append(self.allocator": 1,
        "for (self.global_decl_artifacts.items) |global| try self.emitGlobal(global);": 1,
        ...
        "for (artifacts.decl_artifacts) |artifact| switch (artifact)": 0,
