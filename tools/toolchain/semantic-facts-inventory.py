...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/legacy_backend_syntax.zig": {
        ...
        "pub fn forDecls(decls: []const ast.Decl) LegacyDeclarationSlice": 1,
        ...
        "pub fn declsForEarlyDeclarationScan(self: LegacyDeclarationSlice) []const ast.Decl": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "early_metadata.moduleForComptimeEvaluation()": 0,
        "early_metadata.declsForEarlyDeclarationScan()": 0,
        "declarations.declsForEarlyDeclarationScan()": 1,
        "program.source_spelling": 1,
        "source_spelling: backend_mod.SourceSpellingView": 1,
