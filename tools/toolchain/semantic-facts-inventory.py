...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "return self.directCallResultTypeForExpr(expr, isArrayDirectCallResultType);": 1,
        ...
        "return self.directCallResultTypeForCall(call, isSliceDirectCallResultType);": 1,
