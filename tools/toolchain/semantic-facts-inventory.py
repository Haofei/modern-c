...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "decl_artifacts: []const DeclArtifact": 1,
        ...
        "try decl_artifacts.append(allocator, .{ .function = FunctionArtifact.fromDecl(fn_decl, decl.attrs, false) })": 1,
        "try decl_artifacts.append(allocator, .{ .function = FunctionArtifact.fromDecl(fn_decl, decl.attrs, true) })": 1,
        ...
        "try decl_artifacts.append(allocator, .{ .type_decl = .{ .type_alias = alias } })": 1,
        "try decl_artifacts.append(allocator, .{ .type_decl = .{ .struct_decl = struct_decl } })": 1,
        "try decl_artifacts.append(allocator, .{ .type_decl = .{ .enum_decl = enum_decl } })": 1,
        "try decl_artifacts.append(allocator, .{ .type_decl = .{ .union_decl = union_decl } })": 1,
        "try decl_artifacts.append(allocator, .{ .type_decl = .{ .packed_bits_decl = packed_bits_decl } })": 1,
        "try decl_artifacts.append(allocator, .{ .type_decl = .{ .overlay_union_decl = overlay_union } })": 1,
        "body: ast.Block": 0,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "declaration_artifacts.EarlyDeclarationArtifacts": 8,
        ...
        "for (artifacts.decl_artifacts) |artifact|": 3,
    ...
    "src/lower_llvm.zig": {
        ...
        ".decl_artifacts = early_metadata.decl_artifacts": 1,
        "for (self.decl_artifacts) |artifact|": 2,
