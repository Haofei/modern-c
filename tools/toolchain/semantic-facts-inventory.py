...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "pub fn fromDecl(allocator: std.mem.Allocator, fn_decl: ast.FnDecl, attrs: []const ast.Attr, is_extern: bool, return_ty: mir.ValueType, param_types: []const mir.ValueType) !FunctionArtifact": 1,
        ...
        "ty: ?ast.TypeExpr": 0,
        "init: ?ast.Expr": 0,
        "pub fn fromDecl(global: ast.GlobalDecl, checked: ?mir.CheckedGlobalFact) GlobalArtifact": 1,
