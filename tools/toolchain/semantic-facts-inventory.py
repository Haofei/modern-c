...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/backend_cleanup.zig": {
        ...
        "fn autoDropLocalCleanupFromMirCfg": 1,
        "fn typeOwnershipFactForTypeName": 1,
        "fn valueIdForLocal": 1,
        ...
        "test \"cleanup state snapshot restores full contents\"": 1,
        "fn deferCleanupRefAfter": 1,
        "fn deferCleanupSourceOrder": 1,
        "test \"defer cleanup state refs must be valid ordered and unique\"": 1,
        "call: ast.Expr": 0,
        "pub const DeferredCleanup": 0,
        "raw_expr: ast.Expr": 0,
        ...
        "entries: std.ArrayList(CleanupRef)": 1,
        "pub fn removeAutoDropCleanupForLocalName": 0,
        "pub fn removeAutoDropCleanup(": 0,
        "fn removeAutoDropCleanup(": 0,
        "fn removeAutoDrop(self: *CleanupState": 1,
        "mir_ownership_authority.AutoDropCleanupKey": 0,
        "mir_ownership_authority.OwnershipCleanupRemovalRef": 4,
        "fn autoDropCleanupMatchesRef": 1,
        "fn cleanupRemovalRefFromMirCancellation": 1,
        "fn cleanupRemovalRefFromMirExplicitDropAction": 1,
        "fn explicitDropActionEntryFromMirPlan": 1,
        "fn localHasConsumingCancellationEvent": 0,
        "fn localHasConsumingAutoDropResourceEvent": 1,
        "fn typeSymbolHasDropGlue": 1,
        "fn dropGlueReleaseFunctionExists": 1,
        "fn cleanupCancellationEntryFromMirPlan": 1,
        ...
        "test \"auto-drop cleanup state removal uses typed local identity\"": 1,
    },
    "src/sema.zig": {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "cleanup_state: backend_cleanup.CleanupState": 1,
        ...
        "backend_cleanup.cleanupStateAdmittedByMir": 1,
        ...
        "self.cleanup_state.capture(self.allocator)": 2,
        "self.cleanup_state.restore(saved_cleanup_state)": 4,
        "self.cleanup_state.restoreToCursor(": 7,
        "backend_cleanup.restoreDeferCleanupStackLength": 0,
        "fn restoreDeferStackSnapshot": 0,
        "self.defer_stack.items.len = ": 0,
        "fn validateCleanupState": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "self.cleanup_state.capture(self.allocator)": 2,
        "self.cleanup_state.restore(saved_cleanup_state)": 4,
        "self.cleanup_state.restoreToCursor(": 4,
        "backend_cleanup.restoreDeferCleanupStackLength": 0,
        "fn restoreDeferStackSnapshot": 0,
        "self.defer_stack.items.len = ": 0,
        "fn validateCleanupState": 1,
