...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/early_declaration_metadata.zig": {
        ...
        "packed_bits: []const ast.PackedBitsDecl": 1,
        "overlay_unions: []const ast.OverlayUnionDecl": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "self.comptime_declarations = declarations;": 1,
        ...
        "early_declaration_metadata.EarlyDeclarationArtifacts": 8,
    ...
    "src/lower_c_module.zig": {
        ...
        "emitter.setComptimeDeclarations(.{": 1,
