...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/mir_ownership_authority.zig": {
        ...
        "ast_query.dropPointerReleaseParamTypeName(artifact.toDecl())": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "type_bridge.dropPointerReleaseParamTypeName(fn_decl)": 1,
        ...
        "try self.collectFnDeclArtifact(function.toDecl(), function.attrs, function.is_extern)": 1,
        ...
        "FunctionDeclArtifact.fromDecl(fn_decl, attrs, is_extern)": 1,
        "artifact.fn_decl": 0,
        "const fn_decl = artifact.toDecl();": 3,
    ...
    "src/lower_llvm.zig": {
        ...
        "const fn_decl = function.toDecl();": 2,
        ...
        "try self.collectFunction(fn_decl, function.attrs)": 1,
        "try self.collectGlobal(global)": 1,
        ...
        "LlvmFunctionDeclArtifact.fromDecl(fn_decl, function.attrs, function.is_extern)": 1,
        "artifact.fn_decl": 0,
