...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/codegen_request.zig": {
        '@import("early_declaration_metadata.zig")': 1,
        '@import("source_map_rows.zig")': 1,
        "early_declaration_metadata: early_declaration_metadata.EarlyDeclarationMetadataView": 0,
        "early_declaration_metadata: early_declaration_metadata.EarlyDeclarationArtifacts": 1,
    ...
    "src/early_declaration_metadata.zig": {
        ...
        "pub const SourceMapRowsView = struct": 0,
        "pub const DeclarationSlice = []const ast.Decl": 0,
        "decls: []const ast.Decl": 1,
        "decls: DeclarationSlice": 0,
        "const_fns: []const ast.FnDecl": 0,
        "const_globals: []const ast.GlobalDecl": 0,
        "packed_bits: []const ast.PackedBitsDecl": 0,
        "overlay_unions: []const ast.OverlayUnionDecl": 0,
        "decl_artifacts: []const DeclArtifact": 0,
        "pub const DeclArtifact = union(enum)": 0,
        ".decls = decls": 0,
        "pub fn forLegacySyntax(syntax_module: ast.Module) LegacyDeclarationSlice": 0,
        "pub fn forDecls(decls: []const ast.Decl) LegacyDeclarationSlice": 0,
        "pub fn forDecls(decls: DeclarationSlice) LegacyDeclarationSlice": 0,
        "pub fn forDecls(decls: DeclarationSlice) EarlyDeclarationMetadataView": 0,
        "pub fn collectFromDecls(allocator: std.mem.Allocator, decls: DeclarationSlice) !EarlyDeclarationArtifacts": 0,
        "pub fn collectFromDecls(allocator: std.mem.Allocator, decls: []const ast.Decl) !EarlyDeclarationArtifacts": 1,
        "pub fn syntaxForLegacyLowering(self: LegacyDeclarationSlice) ast.Module": 0,
        "pub fn syntaxForCEarlyDeclarationMetadata(self: LegacyDeclarationSlice) ast.Module": 0,
        "pub fn syntaxForLlvmEarlyDeclarationMetadata(self: LegacyDeclarationSlice) ast.Module": 0,
        "pub fn cEarlyDeclarationMetadata(self: LegacyDeclarationSlice) LegacyDeclarationSlice": 0,
        "pub fn llvmEarlyDeclarationMetadata(self: LegacyDeclarationSlice) LegacyDeclarationSlice": 0,
        "pub fn syntaxForEarlyDeclarationScan(self: LegacyDeclarationSlice) ast.Module": 0,
        "pub fn moduleForComptimeEvaluation(self: LegacyDeclarationSlice) ast.Module": 0,
        "pub fn earlyDeclarationMetadata(self: LegacyDeclarationSlice) EarlyDeclarationMetadataView": 0,
        "pub fn declsForEarlyDeclarationScan(self: LegacyDeclarationSlice) []const ast.Decl": 0,
        "pub fn declsForEarlyDeclarationScan(self: EarlyDeclarationMetadataView) []const ast.Decl": 0,
        "pub fn declsForEarlyDeclarationScan(self: EarlyDeclarationMetadataView) DeclarationSlice": 0,
        "pub fn declsForLegacyArtifactEnumeration(self: EarlyDeclarationArtifacts) DeclarationSlice": 0,
        "pub fn syntaxForRowEnumeration(self: SourceMapRowsView) ast.Module": 0,
        "pub fn declsForRowEnumeration(self: SourceMapRowsView) []const ast.Decl": 0,
        "pub fn forLegacySyntax(syntax_module: ast.Module) SourceMapRowsView": 0,
        "pub fn forDecls(decls: []const ast.Decl) SourceMapRowsView": 0,
    },
    "src/source_map_rows.zig": {
        '@import("ast.zig")': 1,
        '@import("early_declaration_metadata.zig")': 1,
        "pub const SourceMapRowsView = struct": 0,
        "pub const SourceMapRows = struct": 1,
        "pub const RowArtifact = union(enum)": 1,
        "decls: []const ast.Decl": 0,
        "decls: []const early_declaration_metadata.DeclArtifact": 0,
        "source_artifacts: []const early_declaration_metadata.SourceMapArtifact": 1,
        ".decls = decls": 0,
        "pub fn declsForRowEnumeration(self: SourceMapRowsView) []const ast.Decl": 0,
        "pub fn collectFromDecls(allocator: std.mem.Allocator, decls: []const ast.Decl) !SourceMapRows": 0,
        "pub fn collectFromArtifacts(": 0,
        "pub fn collectFromSourceArtifacts(": 1,
    },
    "src/lower_llvm_prelude.zig": {
    ...
    "src/mir_source_bridge.zig": {
        ...
        "pub fn targetTypeFactAtSpanWithExplicitModuleFallback(": 1,
        "pub fn targetTypeFactMatchingType(": 1,
        "pub fn atomicInitPayloadTypeAt(": 1,
        "pub fn targetTypeFactAtOwnedWithModuleFallback(": 0,
        "pub fn targetTypeFactAtOwnedSpanWithExplicitModuleFallback(": 1,
    ...
    "src/lower_c.zig": {
        ...
        "EarlyDeclarationArtifacts.collectFromDecls(allocator, module.decls)": 2,
        ...
        "SourceMapRows.collectFromSourceArtifacts(allocator, early_metadata.source_map_artifacts)": 1,
    ...
    "src/lower_c_map.zig": {
        ...
        "try mapper.collectRowArtifacts(source_map.artifacts);": 1,
        ...
        "fn collectRowArtifacts(self: *SourceMapEmitter, artifacts: []const source_map_rows.RowArtifact) !void": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "EarlyDeclarationArtifacts.collectFromDecls(allocator, module.decls)": 3,
        "for (decls) |decl|": 0,
        ...
        "for (artifacts) |artifact| switch (artifact)": 2,
        "for (artifacts.callable_value_artifacts) |artifact| switch (artifact)": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "for (self.type_artifacts) |artifact|": 1,
        "for (self.callable_value_artifacts) |artifact|": 1,
        ...
        "try self.collectFunction(function.fn_decl, function.attrs)": 2,
