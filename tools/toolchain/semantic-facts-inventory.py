...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "const DeferredCleanup = mir_ownership_authority.DeferredCleanup": 1,
        "const AutoDropCleanupEntry = struct": 0,
        ".fn_name = drop_fn": 0,
        "ownership_facts.AutoDropLocalCleanup": 0,
        "mir_ownership_authority.AutoDropLocalCleanup": 1,
        ...
        "mir_ownership_authority.removeAutoDropCleanupForLocalName": 2,
        ...
        "mir_ownership_authority.moveAutoDropCancellationDecision": 1,
        "mir_ownership_authority.explicitDropCancellationDecision": 1,
        ...
        "for (self.function_decl_artifacts.items) |artifact|": 4,
        ...
        "const kind = self.mirCallTargetKindAt(call.callee.*.span) orelse return null;": 0,
    ...
    "src/lower_llvm.zig": {
        ...
        "for (self.global_decl_artifacts.items) |global| try self.emitGlobal(global);": 1,
        "for (self.function_decl_artifacts.items) |artifact|": 2,
