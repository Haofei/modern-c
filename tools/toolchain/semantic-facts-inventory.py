...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/early_declaration_metadata.zig": {
        ...
        "pub const DeclarationSlice = []const ast.Decl": 1,
        "decls: []const ast.Decl": 0,
        "decls: DeclarationSlice": 2,
        ...
        "pub fn collectFromDecls(allocator: std.mem.Allocator, decls: DeclarationSlice) !EarlyDeclarationArtifacts": 1,
        ...
        "pub fn declsForLegacyArtifactEnumeration(self: EarlyDeclarationArtifacts) DeclarationSlice": 1,
    ...
    "src/source_map_rows.zig": {
        ...
        ".decls = decls": 0,
        "pub fn declsForRowEnumeration(self: SourceMapRowsView) []const ast.Decl": 0,
        "pub fn collectFromDecls(allocator: std.mem.Allocator, decls: []const ast.Decl) !SourceMapRows": 1,
    },
    "src/lower_llvm_prelude.zig": {
    ...
    "src/lower_c.zig": {
        ...
        "SourceMapRows.collectFromDecls(allocator, module.decls)": 1,
