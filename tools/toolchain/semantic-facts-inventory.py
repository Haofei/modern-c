...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    "src/backend.zig": {
        ...
        "pub const SourceMapMechanicsView = legacy_backend_syntax.SourceMapMechanicsView": 0,
        "pub const LegacyDeclarationSlice = struct": 0,
        "pub const SourceMapMechanicsView = struct": 0,
        "syntax_module: ast.Module": 0,
        "decls: []const ast.Decl": 0,
        "declaration_metadata: LegacyDeclarationSlice": 0,
        "source_map_mechanics: SourceMapMechanicsView": 0,
        "source_map: SourceMapMechanicsView": 0,
        "source_map: legacy_backend_syntax.SourceMapMechanicsView": 0,
        ...
        ".source_map_mechanics = SourceMapMechanicsView.forDecls(decls)": 0,
        ...
        "pub fn sourceMapMechanics(self: VerifiedProgram) SourceMapMechanicsView": 0,
        "return self.source_map_mechanics;": 0,
    },
    ...
    "src/early_declaration_metadata.zig": {
        '@import("ast.zig")': 1,
        "pub const LegacyDeclarationSlice = struct": 0,
        "pub const EarlyDeclarationMetadataView = struct": 1,
        "pub const SourceMapMechanicsView = struct": 0,
        ...
        "pub fn forDecls(decls: DeclarationSlice) EarlyDeclarationMetadataView": 1,
        ...
        "pub fn declsForEarlyDeclarationScan(self: EarlyDeclarationMetadataView) DeclarationSlice": 1,
        "pub fn syntaxForRowEnumeration(self: SourceMapMechanicsView) ast.Module": 0,
        "pub fn declsForRowEnumeration(self: SourceMapMechanicsView) []const ast.Decl": 0,
        "pub fn forLegacySyntax(syntax_module: ast.Module) SourceMapMechanicsView": 0,
        "pub fn forDecls(decls: []const ast.Decl) SourceMapMechanicsView": 0,
    },
    "src/source_map_mechanics.zig": {
        '@import("ast.zig")': 1,
        "pub const SourceMapMechanicsView = struct": 1,
        "decls: []const ast.Decl": 2,
        ".decls = decls": 1,
    ...
    "src/lower_c.zig": {
        ...
        "EarlyDeclarationMetadataView.forDecls(module.decls)": 1,
        ...
        "early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "early_declaration_metadata.EarlyDeclarationMetadataView": 6,
        ...
        "try emitter.collectModule(early_declaration_metadata.EarlyDeclarationMetadataView.forDecls(module.decls));": 2,
        "for (decls) |decl|": 2,
    ...
    "src/lower_c_module.zig": {
        ...
        "const decls = early_metadata.declsForEarlyDeclarationScan();": 1,
        "collectDropGlueFactsFromMir": 0,
        ...
        "pub fn collect(emitter: anytype, early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView)": 1,
        "pub fn emit(emitter: anytype, early_metadata: early_declaration_metadata.EarlyDeclarationMetadataView)": 1,
    },
    "src/lower_c_convert.zig": {
