...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/legacy_backend_syntax.zig": {
        ...
        "pub fn forDecls(decls: DeclarationSlice) LegacyDeclarationSlice": 1,
        ...
        "pub fn earlyDeclarationMetadata(self: LegacyDeclarationSlice) EarlyDeclarationMetadataView": 1,
    ...
    "src/lower_c.zig": {
        ...
        "LegacyDeclarationSlice.forDecls(module.decls)": 1,
        "LegacyDeclarationSlice.forDecls(module.decls).earlyDeclarationMetadata()": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "legacy_backend_syntax.LegacyDeclarationSlice": 3,
        "legacy_backend_syntax.EarlyDeclarationMetadataView": 3,
        ...
        "try emitter.collectModule(legacy_backend_syntax.LegacyDeclarationSlice.forDecls(module.decls).earlyDeclarationMetadata());": 2,
        "for (decls) |decl|": 2,
