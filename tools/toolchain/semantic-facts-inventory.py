...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/early_declaration_metadata.zig": {
        ...
        "pub const EarlyDeclarationArtifacts = struct": 0,
        "pub const EarlyDeclarationArtifacts = declaration_artifacts.EarlyDeclarationArtifacts": 1,
    ...
    "src/source_map_rows.zig": {
        ...
        "pub const RowArtifact = union(enum)": 0,
        "pub const RowArtifact = declaration_artifacts.SourceMapArtifact": 1,
        "decls: []const ast.Decl": 0,
        "decls: []const early_declaration_metadata.DeclArtifact": 0,
        "source_artifacts: []const early_declaration_metadata.SourceMapArtifact": 0,
        "source_artifacts: []const declaration_artifacts.SourceMapArtifact": 1,
        ".decls = decls": 0,
        "pub fn declsForRowEnumeration(self: SourceMapRowsView) []const ast.Decl": 0,
