...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "global_artifacts: []const ast.GlobalDecl": 1,
        ...
        "try global_artifacts.append(allocator, global)": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "fn collectGlobalArtifacts(self: *CEmitter, artifacts: []const ast_bridge.GlobalDecl) anyerror!void": 1,
