...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "fn directNullableLocalTypeForEmission(": 1,
        "if (self.directNullableLocalTypeForEmission(expr, locals)) |ty| return ty;": 1,
        ...
        "fn dynSourceTypeForEmission(": 1,
        "else => if (self.dynSourceTypeForEmission(expr, locals)) |source_ty|": 1,
        "const source_ty = self.dynSourceTypeForEmission(operand, locals) orelse return false;": 1,
        "const source_ty = self.dynSourceTypeForEmission(expr, locals) orelse return false;": 1,
        ...
        "fn directAggregateMemberCopySourceTypeForEmission(": 1,
        "const source_ty = self.directAggregateMemberCopySourceTypeForEmission(expr, locals) orelse break :blk false;": 1,
    ...
    "src/lower_c_infer.zig": {
        ...
        "fn sliceBaseTypeForZeroSpanSlice(": 1,
        "pub fn sliceTypeForBase(": 1,
        "pub fn enumNameForExpr(": 1,
        "pub fn enumNameForValueExpr(": 1,
        "pub fn enumNameForType(": 1,
        "fn enumNameForIdentValue(": 1,
        ...
        "fn requireExpressionResultType(": 1,
        "pub fn arrayTypeForExpr(": 1,
        "pub fn exprIsPointer(": 1,
        "pub fn derefPointeeType(": 1,
        "fn pointeeTypeFromPointerLike(": 1,
        "pub fn structTypeNameForExpr(": 1,
        "pub fn numericExprTypeForEmission(": 1,
        "fn numericExprTypeForEmissionInferred(": 1,
        "fn castTargetTypeForInference(": 1,
        ...
        "ctx.call_return_type_for_expr(ctx.source_ctx": 9,
        "fn callReturnType(": 0,
        "fn sourceTypeForIdent(": 1,
        "fn structNameFromType(": 1,
        "fn resolveAliasType(": 1,
