...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c.zig": {
        ...
        "declarations": 0,
        "early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "legacy_backend_syntax.EarlyDeclarationMetadataView": 6,
        ...
        "try emitter.collectModule(legacy_backend_syntax.EarlyDeclarationMetadataView.forDecls(module.decls));": 2,
        "for (decls) |decl|": 2,
    ...
    "src/lower_c_module.zig": {
        ...
        "pub fn collect(emitter: anytype, early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView)": 1,
        "pub fn emit(emitter: anytype, early_metadata: legacy_backend_syntax.EarlyDeclarationMetadataView)": 1,
    },
    "src/lower_c_convert.zig": {
