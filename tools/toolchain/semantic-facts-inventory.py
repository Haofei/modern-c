...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/source_map_rows.zig": {
        '@import("ast.zig")': 1,
        "pub const SourceMapRowsView = struct": 1,
        "decls: []const ast.Decl": 2,
        ".decls = decls": 1,
        "pub fn declsForRowEnumeration(self: SourceMapRowsView) []const ast.Decl": 1,
        "pub fn forDecls(decls: []const ast.Decl) SourceMapRowsView": 1,
    },
    "src/lower_llvm_prelude.zig": {
    ...
    "src/lower_c.zig": {
        ...
        "SourceMapRowsView.forDecls(module.decls)": 1,
