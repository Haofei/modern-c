...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "try self.collectEarlyDeclarationMetadataFromDecls(decls);": 1,
        ...
        "try self.collectDeclArtifactsFromDecls(decls);": 1,
        ...
        "if (kind == .expression_result and !isSourceSpan(span)) return null;": 1,
        ...
        "if (!isSourceSpan(span)) return null;": 2,
