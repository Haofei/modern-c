...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    "src/backend.zig": {
        ...
        "decls: []const ast.Decl": 6,
        "declaration_metadata: DeclarationMetadataView": 0,
        ...
        ".decls = decls": 2,
        ".declaration_metadata = DeclarationMetadataView.forDecls(decls)": 0,
        ".source_map_mechanics = SourceMapMechanicsView.forDecls(decls)": 0,
        "pub fn declarationMetadata(self: VerifiedProgram) DeclarationMetadataView": 0,
