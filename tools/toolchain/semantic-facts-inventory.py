...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "try function_artifacts.append(allocator, .{ .fn_decl = fn_decl, .attrs = decl.attrs, .is_extern = false })": 1,
        "try function_artifacts.append(allocator, .{ .fn_decl = fn_decl, .attrs = decl.attrs, .is_extern = true })": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "try self.collectFunction(function.fn_decl, function.attrs)": 1,
        "try self.collectGlobal(global)": 1,
