...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "try self.const_global_widths.put(name, bits);": 1,
        ...
        "pub fn collectEarlyDeclarationMetadata(self: *CEmitter) !void": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "if (eval.comptimeTypeBitWidth(ty)) |bits| try self.const_global_widths.put(name, bits);": 1,
