...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "pub fn collectEarlyDeclarationMetadata(self: *CEmitter, artifacts: CodegenDeclArtifacts) !void": 0,
        ...
        "backend_cleanup.validateFunctionCleanupAuthority": 0,
        ...
        "declaration_artifacts.CodegenDeclarationArtifacts": 0,
        "CodegenDeclArtifacts": 0,
        ...
        "fn collectConstGlobals(self: *CEmitter) !void": 0,
        ...
        "const declarations = self.comptime_declarations orelse return error.UnsupportedCEmission;": 0,
        ...
        "eval.collectConstGlobalsFromDeclarationsWithOptions(self.allocator, declarations, &self.const_fns": 0,
        "scope.module = self.comptime_module": 0,
        "scope.decls = self.comptime_decls": 0,
        "scope.declarations = self.comptime_declarations": 0,
        "try self.const_global_widths.put(global.name.text, bits);": 0,
        "try self.const_global_widths.put(sig.name.text, bits);": 0,
        "try self.const_global_widths.put(name, bits);": 0,
        ...
        "pub fn collectDeclArtifacts(self: *CEmitter, artifacts: CodegenDeclArtifacts) anyerror!void": 0,
        "pub fn collectEarlyDeclarationMetadata(self: *CEmitter) !void": 0,
        ...
        "for (artifacts.decl_artifacts) |artifact|": 0,
        "for (artifacts.decl_artifacts) |global|": 0,
        "eval.collectConstFunctionsFromDeclarations": 0,
        ...
        "try self.collectFunctionArtifact(function)": 0,
        "try self.collectCallableEmissionFacts()": 1,
        "fn collectCallableEmissionFacts(self: *CEmitter) !void": 1,
        ".error_from = function.has_error_from": 0,
        ".error_from = sig.error_from": 0,
        ".error_from = fact.error_from": 1,
        "try self.emitFunction(function, body, function.backend_attrs)": 0,
        "try self.emitFunction(function, body, render_attrs)": 0,
        ...
        "trait_decls: std.StringHashMap(declaration_artifacts.TraitDeclArtifact)": 0,
        ...
        "try self.trait_decls.put(trait_decl.facts.name.text, trait_decl)": 0,
        ...
        "fn emitFunctionPrototype(self: *CEmitter, function: anytype)": 0,
        "fn emitFunctionForwardDecl(self: *CEmitter, function: anytype)": 0,
        "fn emitFunctionPrototype(self: *CEmitter, fact: mir.CallableEmissionFact)": 1,
        "fn emitFunctionForwardDecl(self: *CEmitter, fact: mir.CallableEmissionFact)": 1,
        "fn emitFunction(self: *CEmitter, function: anytype": 0,
        "fn emitFunctionBody(self: *CEmitter, function: anytype": 0,
        ...
        "fn collectGlobalDeclArtifact(self: *CEmitter, global: declaration_artifacts.GlobalArtifact) !void": 0,
        "fn emitGlobal(self: *CEmitter, global: ast_bridge.GlobalDecl) !void": 0,
        "fn emitGlobal(self: *CEmitter, global: declaration_artifacts.GlobalArtifact) !void": 0,
        ...
        # Aggregate-place MIR lowering added existing bridge consumers, while
        # retiring the indirect-call return plan removed one. Capture the
        # reduced state; future changes may only reduce it further.
        "self.structTypeNameFromType(": 5,
        ...
        "self.pointerNodeFromCandidate(": 1,
        ...
        "self.storageOrExpressionResultTypeForEmission(expr, locals)": 7,
        ...
        "mirTargetTypeFactAtOwned(.direct_call_result": 2,
        ...
        "mirTargetTypeFactAt(.dyn_coercion,": 0,
        "mirTargetTypeFactAt(.dyn_coercion_source": 0,
        "fn nullablePayloadFromCandidate(": 1,
        "self.nullablePayloadFromCandidate(": 3,
        "fn dynTraitNameFromCandidate(": 1,
        "self.dynTraitNameFromCandidate(": 2,
        "fn dynDispatchTraitNameFromCandidate(": 0,
        "self.dynDispatchTraitNameFromCandidate(": 0,
        "fn dynPointerSourcePointeeFromCandidate(": 0,
        "self.dynPointerSourcePointeeFromCandidate(": 0,
        ...
        "fn dynPassThroughTypeForEmission(": 0,
        "else => if (self.dynPassThroughTypeForEmission(expr, locals)) |source_ty|": 0,
        ...
        "fn mirResultReturnTypeForCall(": 1,
        "self.mirResultReturnTypeForCall(call, .reflection_result)": 1,
        "self.mirResultReturnTypeForCall(call, .byte_view_result)": 1,
        "self.mirResultReturnTypeForCall(call, .bitcast_target)": 1,
        "self.mirResultReturnTypeForCall(call, .conversion_target)": 1,
        "self.mirResultReturnTypeForCall(call, .phys_result)": 1,
        ...
        "const base_ty = self.memberBaseTypeForEmission(member.base.*, locals) orelse return null;": 0,
        ...
        "return self.generatedExprSourceTypeForEmission(expr, locals);": 2,
        ...
        "self.current_function = global.signature.name.text;": 0,
