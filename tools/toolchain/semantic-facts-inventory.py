...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/lower_c_emitter.zig": {
        ...
        "mir.hasDeferCleanupAtSource": 2,
        "mir.directDeferCallCleanupAtSource": 1,
        "mir.callTargetDeferCleanupAtSource": 2,
        ".{ .direct_call = cleanup }": 1,
        ".{ .call_target = cleanup }": 1,
        ".{ .block = .{ .defer_span = stmt_span, .block = block } }": 1,
        ".{ .trivial_expr = expr }": 0,
    ...
    "src/lower_llvm.zig": {
        ...
        ".{ .direct_call = cleanup }": 1,
        ".{ .call_target = cleanup }": 1,
        ".{ .block = .{ .defer_span = stmt.span, .block = block } }": 1,
        ".{ .trivial_expr = expr }": 0,
        ".{ .call_free_expr = expr }": 0,
        ".{ .raw_expr = expr }": 0,
        "try ownership_facts.makeDropPointerCall": 0,
