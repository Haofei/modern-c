...
EXACT_COUNTS: dict[str, dict[str, int]] = {
    ...
    "src/declaration_artifacts.zig": {
        ...
        "pub const TraitArtifact = union(enum)": 1,
        "trait_artifacts: []const TraitArtifact": 1,
    ...
    "src/lower_c_emitter.zig": {
        ...
        "for (artifacts) |artifact| switch (artifact)": 1,
        ...
        "try self.collectTraitArtifacts(artifacts.trait_artifacts);": 1,
        "fn collectTraitArtifacts(self: *CEmitter, artifacts: []const declaration_artifacts.TraitArtifact) anyerror!void": 1,
    ...
    "src/lower_llvm.zig": {
        ...
        "for (self.trait_artifacts) |artifact|": 1,
