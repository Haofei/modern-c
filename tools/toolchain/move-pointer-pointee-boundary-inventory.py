...
ANCHORS: dict[str, list[str]] = {
    ...
    "src/sema_move.zig": [
        ...
        "cannot move a linear `move` value through a pointer alias in ownership v0",
    ...
    "tests/spec/move_place.mc": [
        "reject_move_field_through_full_alias",
        "reject_move_array_element_through_full_alias",
        "reject_move_dynamic_array_element_through_full_alias",
        "reject_move_nested_dynamic_array_element_through_full_alias",
        "reject_move_nested_dynamic_array_field_element_through_full_alias",
        "reject_assigned_uninit_pointer_dynamic_array_element_alias_move_through",
