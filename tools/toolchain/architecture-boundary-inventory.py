...
EXACT_FILE_COUNTS = {
    ...
    ("src/driver_codegen_inputs.zig", "DeclarationArtifacts.collectFromSyntaxDecls(session.allocator, module.decls)"): 1,
    ("src/driver_codegen_inputs.zig", "DeclarationArtifacts.collectFromResolvedDecls(session.allocator, graph.*, resolved_decls)"): 1,
