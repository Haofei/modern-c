...
EXACT_FILE_COUNTS = {
    ...
    ("src/driver_codegen_inputs.zig", "DeclarationArtifacts.collectFromResolvedDecls(session.allocator, fallback_decls)"): 1,
    ...
    ("src/declaration_artifacts.zig", "fn collectFromSyntaxDecls("): 1,
    ("src/declaration_artifacts.zig", "fn collectFromDeclItems("): 1,
