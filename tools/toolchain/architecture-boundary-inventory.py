...
EXACT_FILE_COUNTS = {
    ...
    ("src/driver_codegen_inputs.zig", "@import(\"module_parser.zig\")"): 0,
    ...
    ("src/driver_codegen_inputs.zig", "session.buildVerifiedProgramFromDecls(decls"): 1,
    ("src/driver_codegen_inputs.zig", "DeclarationArtifacts.collectFromResolvedDecls(session.allocator, resolved_decls)"): 1,
    ...
    ("src/driver_codegen_inputs.zig", "fn collectDeclarationArtifacts(session: *CompilationSession)"): 1,
    ...
    ("src/sema.zig", "module.visibility_mode"): 1,
    ("src/sema.zig", "module.qualified_owners"): 1,
    ...
    ("src/compiler_session.zig", "name_resolve.transformDeclsWithSymbols(allocator, module.decls"): 1,
    ("src/compiler_session.zig", "async_lower.transform(allocator, resolved"): 0,
    ("src/compiler_session.zig", "async_lower.transformDecls(allocator, resolved.decls"): 1,
    ("src/compiler_session.zig", "generic_precheck.check(allocator, lowered"): 0,
    ("src/compiler_session.zig", "generic_precheck.checkDecls(allocator, lowered.decls"): 1,
    ("src/compiler_session.zig", "monomorphize.transformReport(allocator, lowered"): 0,
    ("src/compiler_session.zig", "monomorphize.transformDeclsReport(allocator, lowered.decls"): 1,
    ("src/compiler_session.zig", "mangle_private.transform(allocator, specialized"): 0,
    ("src/compiler_session.zig", "mangle_private.transformDecls(allocator, specialized.decls"): 1,
    ...
    ("src/module_parser.zig", "name_resolve.transformDeclsWithSymbols(allocator, file.module.decls"): 1,
