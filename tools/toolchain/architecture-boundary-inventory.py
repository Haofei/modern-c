...
EXACT_FILE_COUNTS = {
    ...
    ("src/mir_facts_view.zig", "targetTypeFactAtSpanWithExplicitModuleFallback"): 1,
    ("src/mir_facts_view.zig", "targetTypeFactAtOwnedSpanWithExplicitModuleFallback"): 1,
    ...
    ("src/lower_c_emitter.zig", "targetTypeFactAtSpanWithExplicitModuleFallback"): 1,
    ("src/lower_c_emitter.zig", "targetTypeFactAtOwnedSpanWithExplicitModuleFallback"): 1,
    ("src/lower_llvm.zig", "targetTypeFactAtWithModuleFallback"): 0,
    ("src/lower_llvm.zig", "targetTypeFactAtOwnedWithModuleFallback"): 0,
    ("src/lower_llvm.zig", "targetTypeFactAtSpanWithExplicitModuleFallback"): 1,
    ("src/lower_llvm.zig", "targetTypeFactAtOwnedSpanWithExplicitModuleFallback"): 1,
    ...
    ("src/mir_source_bridge.zig", "pub fn targetTypeFactAtSpanWithExplicitModuleFallback("): 1,
    ...
    ("src/mir_source_bridge.zig", "pub fn targetTypeFactAtOwnedSpanWithExplicitModuleFallback("): 1,
