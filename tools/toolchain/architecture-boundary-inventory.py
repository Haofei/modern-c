...
EXACT_FILE_COUNTS = {
    ...
    ("src/lower_llvm.zig", "targetTypeFactAtOwnedCurrentSpan"): 0,
    ...
    ("src/verified_program.zig", "checked: checked_program.CheckedProgram"): 1,
    ("src/checked_program.zig", "pub const CheckedProgram = struct"): 1,
    ("src/checked_program.zig", "@import(\"ast.zig\")"): 0,
    ("src/checked_program.zig", "@import(\"parser.zig\")"): 0,
    ("src/checked_program.zig", "@import(\"sema"): 0,
    ("src/mir_model.zig", "pub const CheckedCallableFact = struct"): 1,
    ...
    ("src/loader.zig", "*textual inclusion*"): 0,
    ...
    ("src/module_graph.zig", "combined textual source"): 0,
    ...
    ("src/main.zig", "hir.appendDumpFromDecls(allocator, parsed.decls(), &output)"): 0,
    ("src/main.zig", "hir.appendDumpFromDecls(allocator, decls, &output)"): 0,
    ("src/driver_check.zig", "hir.appendDumpFromDecls(allocator, decls, &output)"): 1,
    ...
    ("src/main.zig", "hir.appendVerificationFactsFromDecls(allocator, parsed.decls(), &output)"): 0,
    ("src/main.zig", "hir.appendVerificationFactsFromDecls(allocator, decls, &output)"): 0,
    ("src/driver_check.zig", "hir.appendVerificationFactsFromDecls(allocator, decls, &output)"): 1,
    ...
    ("src/compiler_session.zig", "pub const CheckedSyntaxModule = struct"): 0,
    ("src/compiler_session.zig", "pub const ParsedModule = struct"): 0,
    ...
    ("src/compiler_session.zig", "fn parseModuleOrReportMode(self: *CompilationSession, source: []const u8, allocator: std.mem.Allocator, diag: *diagnostics.Reporter, render_errors: bool) !ParsedModule"): 0,
    ("src/compiler_session.zig", ") !CheckedSyntaxModule {"): 0,
    ...
    ("src/compiler_session.zig", "name_resolve.transformDeclsWithSymbols(allocator, decls, qualified_symbols"): 0,
    ...
    ("src/compiler_session.zig", "generic_precheck.checkDecls(allocator, decls, visibility_mode"): 0,
    ...
    ("src/compiler_session.zig", "mangle_private.transformDecls(allocator, decls, visibility_mode"): 0,
    ...
    ("src/mangle_private.zig", "pub fn transformDecls("): 0,
    ("src/mangle_private.zig", "pub fn transformDeclsForFiles("): 1,
    ("src/mangle_private_tests.zig", "mangle_private.transform(arena.allocator(), module"): 0,
    ("src/mangle_private_tests.zig", "mangle_private.transformDecls(arena.allocator(), module.decls"): 0,
    ...
    ("src/module_parser.zig", "name_resolve.transformDeclsWithSymbols(allocator, file.decls(), file.qualifiedSymbols(), null)"): 0,
    ("src/module_parser.zig", "name_resolve.transformDeclsWithSymbols(allocator, file.decls(), qualified_symbols.items, &graph)"): 1,
...
REQUIRED_ANCHORS = {
    ...
    "src/loader.zig": (
        "retained independently in SourceDatabase",
        "connected through ModuleGraph",
        "parser views",
    ),
