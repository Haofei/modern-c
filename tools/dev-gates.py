...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        ("tools/toolchain/mcc-inspection-modules-test.sh",),
        ("mcc-inspection-modules-test",),
    ...
    Rule(
        ...
        "shared MC audit changes need every retained security audit mode",
    ...
    Rule(
        ...
        "mcfuzz framework changes need the current mcfuzz oracle family and persisted corpus replay",
    ),
    Rule(
        ("tools/fuzz/mcref.py",),
        ("fuzz-reference",),
        "reference interpreter changes need the independent reference oracle",
    ),
    Rule(
        ("tools/fuzz/corpus/*.mc",),
        ("fuzz-corpus",),
