...
SRC="$HERE/tests/qemu/e1000_demo.mc"
...
if printf '%s' "$OUT" | grep -q "E1000-OK"; then
    echo "PASS: e1000-test — real-hardware NIC driver: PCI-enumerated + found the Intel e1000 (vendor 0x8086/dev 0x100E) and read its BAR over ECAM config space (E1000-OK) under QEMU"
    exit 0
fi
echo "FAIL: e1000-test — expected E1000-OK"
exit 1
