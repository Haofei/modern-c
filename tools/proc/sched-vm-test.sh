...
RUNTIME="$HERE/tests/qemu/proc/sched_vm_runtime.mc"
...
kernel_boot_link_run "$TEST_NAME" "SCHED-VM-OK" \
    "$BACKEND backend scheduler switched per-process address spaces; each process saw its own frame under QEMU" \
