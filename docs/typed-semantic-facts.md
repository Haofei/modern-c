...
callback slot and two exact-count-gated uses: variadic tail argument type
selection, and pointer-to-`paddr` cast detection for sequenced temps. Those two
uses are migration targets, not expandable authority.
