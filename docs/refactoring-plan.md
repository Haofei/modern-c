...
| 244 | Rename inspection surfaces at the CLI boundary. | Complete: `inspect-hir`, `verify-inspect-hir`, and `inspect-ir` are now the documented inspection commands; help/docs state that inspection artifacts are not backend pipeline inputs. |
