...
| Semantic facts / typed MIR | [`typed-semantic-facts.md`](typed-semantic-facts.md) | How semantic information reaches the backends, and the backend-import rule that keeps it that way. |
