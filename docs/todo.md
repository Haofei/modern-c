...
| P1 | Updates and recovery | Kernel update/live-update fixtures were removed from the current language-oriented scope. | Reintroduce product update/recovery only behind a concrete product profile. |
...
- [ ] Storage and network run through retained brokered validation paths.
