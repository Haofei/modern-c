...
local initialization stores, direct assignment stores, volatile raw/MMIO stores,
atomic stores, precise asm output stores, returns, calls, checked-arithmetic
trap paths, inline asm, related runtime helper calls,
