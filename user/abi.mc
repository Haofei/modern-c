...
// Simple FS tool ops for runtime fixtures. They complete READY IMMEDIATELY (no delay), so the
// first SYS_POLL delivers them. Request-payload convention (in_ptr/in_len):
