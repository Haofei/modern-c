...
pub fn register(ctx: *h.Ctx) void {
    ...
    m0_full_step.dependOn(ctx.cmd("wamr-run-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wamr-run-test"));
    m0_full_step.dependOn(ctx.cmd("wamr-fuel-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wamr-fuel-test"));
    m0_full_step.dependOn(ctx.cmd("wamr-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wamr-agent-test"));
    ...
    m0_full_step.dependOn(ctx.cmd("wasm-wasi-hello-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-wasi-hello-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-realtool-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-realtool-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-nettool-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-nettool-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-js-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-js-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-js-nettool-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-js-nettool-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-async-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-async-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-cancel-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-cancel-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-quota-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-quota-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-spurious-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-spurious-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-agent-smoke-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-agent-smoke-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-cancel-edges-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-cancel-edges-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-broker-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-broker-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-smode-confined-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-smode-confined-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-smode-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-smode-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-smode-async-agent-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-smode-async-agent-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-smode-net-irq-tool-test"));
    ...
    m0_full_step.dependOn(ctx.cmd("llvm-x86-wasm-async-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-js-bench-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-js-bench-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-memcap-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-memcap-test"));
    m0_full_step.dependOn(ctx.cmd("wasm-biggrow-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-biggrow-test"));
    ...
    m0_full_step.dependOn(ctx.cmd("wasm-watchdog-test"));
    m0_full_step.dependOn(ctx.cmd("llvm-wasm-watchdog-test"));
